...
export function createTomb6(scene) {

    tomb6 = new THREE.Group();

    createEntrance();

    createMainRoom();

    tomb6.position.set(20, -4, -35);
    tomb6.rotation.y = -Math.PI / 2;
...
function createDoor(room) {
    ...
    internalDoor6.position.set(
        25,
        0.9,
        -19.6
    );

    room.add(internalDoor6);
    addCollider(internalDoor6);
