...
export function createTomb1(scene) {

    tomb1 = new THREE.Group();
...
function createDoor(room) {
    ...
    internalDoor1.position.set(
        25,
        0.9,
        -19.6
    );

    room.add(internalDoor1);
    addCollider(internalDoor1);
